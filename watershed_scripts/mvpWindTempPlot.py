...
if __name__ == '__main__':
	...
	for key in dataDict:
	    ...
	    try:
                self.markerBand(str(float(32)),'Freezing', tempView, 'black', 'soild')
	    except NameError:
	        print("couldn't add marker band")
	    ...
	    try:
	        ...
	        print("couldn't add marker band")
	    try:
	        self.markerBand('90', 'East', windDirView, 'red')
	        self.markerBand('180', 'South', windDirView, 'red')
	        self.markerBand('270', 'West', windDirView, 'red')
	        self.markerBand('32', 'Freezing', windDirView, 'black')
	    except:
